...
Restent ensuite : **CONTR-1**, la contradiction — la dette court depuis AMB-3 et personne ne la lit encore. C'est le chemin critique : elle rend son sens à la révision (dette effacée, donc bonus rétroactif payable sans rien annoncer) et ferme la boucle voir → payer → être puni de ne pas payer. Puis `faux` (MOD-3), l'instrument **Élève**, l'acte IV, et la relecture de fin. Voir `docs/design-doc.md` §7 et §8, et `docs/backlog-1.0.md` pour le découpage.
